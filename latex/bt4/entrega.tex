...
El dataset resultante, denominado \texttt{bt4}, consta de un subconjunto de 2000 imágenes 
seleccionadas de forma uniformemente aleatoria de entre las primeras 50000 de ZOD. 
Estas se encuentran divididas en un 80\% para entrenamiento (\textit{Train}) y un 20\% 
para validación (\textit{Val}).

% Un mosaico 3x2 de imágenes de ejemplo con sus bounding boxes
\begin{figure}[H]
    \centering
    \begin{tabular}{ccc}
        \includegraphics[width=0.3\textwidth]{images/bt4/000080.png} &
        \includegraphics[width=0.3\textwidth]{images/bt4/000196.png} &
        \includegraphics[width=0.3\textwidth]{images/bt4/000329.png} \\
        \includegraphics[width=0.3\textwidth]{images/bt4/000742.png} &
        \includegraphics[width=0.3\textwidth]{images/bt4/001955.png} &
        \includegraphics[width=0.3\textwidth]{images/bt4/002152.png} \\
    \end{tabular}
...
\begin{enumerate}
    ...
    \item Se congelan parcialmente o se entrenan con una tasa de aprendizaje baja las capas del Backbone para conservar la capacidad de extracción de características básicas (bordes, texturas).
...
\begin{itemize}
    ...
    \item \textbf{Épocas (\texttt{epochs}):} Representa el número de veces que el modelo ve el dataset completo. 
     Se configuró un máximo de 100 épocas, utilizando un mecanismo de early stopping
...
\begin{figure}[H]
    \centering
    \begin{tabular}{cc}
        \includegraphics[width=0.45\textwidth]{images/bt4/confusion_matrix_nano.png} &
        \includegraphics[width=0.45\textwidth]{images/bt4/confusion_matrix_medium.png} \\
...
\begin{figure}[H]
    \includegraphics[width=0.9\textwidth]{images/bt4/metrics.png}
...
tarda alrededor de 7 ms. Dado que el ubbmbral para aplicaciones en tiempo real suele situarse en torno a los 33 ms (30 fps), 
...
\begin{figure}[H]
    ...
    \begin{tabular}{cc}
        ...
        (a) ZOD 001237 YOLOv8 Nano & (b) ZOD 001237 YOLOv8 Medium \\
        ...
        (a) ZOD 006283 YOLOv8 Nano & (b) ZOD 006283 YOLOv8 Medium \\
    \end{tabular}
    \caption{Predicciones con (a) YOLOv8 Nano y (b) YOLOv8 Medium.}
