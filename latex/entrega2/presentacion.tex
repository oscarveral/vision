...
\section{Descriptores Locales y Matching}
...
\begin{frame}{Comparación de Descriptores Locales}
  \begin{columns}
    ...
    \textbf{Ratio test de Lowe} para filtrar matches incorrectos
    \hfill
    \column{0.55\textwidth}
    \begin{figure}
      \includegraphics[width=\textwidth]{images/keypoints_comparisons.png}
...
\begin{frame}{Template Matching con RANSAC}
  \begin{columns}
    ...
    \column{0.5\textwidth}
    \begin{figure}
      \includegraphics[width=\textwidth]{images/good_matching2.png}
      \caption{Resultado de matching con RANSAC}
    \end{figure}
  \end{columns}
\end{frame}

\section{Clasificador HOG+SVM}
...
\begin{frame}{Conclusiones}
  \textbf{Descriptores locales:}
  \begin{itemize}
    \item SIFT más robusto globalmente
    \item Template matching limitado en condiciones reales
  \end{itemize}
  
  \vspace{0.3cm}
  \textbf{Clasificador HOG+SVM:}
  \begin{itemize}
    \item Buena clasificación a nivel de parche
    \item Problema: etiquetado del dataset y generalización
  \end{itemize}
